export const data = {
  banner: [
    {
      to: '/link',
      img: '../../images/workshop/cldnry_fashion_pdp_basic_tee6.jpg',
  ...
  products: [
    ...
    },
    {
      ...
      link: '/product/detail',
      name: 'Great product name goes here',
      img: '../../images/workshop/cldnry_fashion_pdp_basic_tee5.jpg',
      price: 475,
      originPrice: 0,
      discountPrice: 0,
    ...
    },
    {
      ...
      link: '/product/detail',
      name: 'Great product name goes here',
      img: '../../images/workshop/cldnry_fashion_pdp_basic_tee4.jpg',
      price: 1900,
      originPrice: 2000,
      discountPrice: 100,
      discountPercentage: 0,
    ...
    },
    {
      ...
      link: '/product/detail',
      name: 'Great product name goes here',
      img: '../../images/workshop/cldnry_fashion_pdp_basic_tee1.jpg',
      price: 10,
      originPrice: 0,
      discountPrice: 0,
      discountPercentage: 0,
    ...
    },
    {
      ...
      isFreeShipping: false,
      description:
        'Best Book ever | Winner of awards | Soon to be a movie!'
    }
  ],
  blogBanner: [
    {
